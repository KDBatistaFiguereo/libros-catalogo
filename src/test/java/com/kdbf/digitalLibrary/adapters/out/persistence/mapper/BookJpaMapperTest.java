...
public class BookJpaMapperTest {
  ...
  void testToDomain() {
    ...
    BookJpaEntity bookJpa = new BookJpaEntity(1L, UUID.randomUUID(), "Test Book", "English", 100, authorJpa);
  ...
  void testToDomainList() {
    ...
    BookJpaEntity bookJpa1 = new BookJpaEntity(1L, UUID.randomUUID(), "Book 1", "English", 100, authorJpa);
    BookJpaEntity bookJpa2 = new BookJpaEntity(2L, UUID.randomUUID(), "Book 2", "Spanish", 200, authorJpa);
